        ...
        effect_changes: [
            {
                effect_entries: [
                    ...
                    {
                        effect: "Does not absorb non-damaging electric moves, i.e. thunder wave.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    {
                        effect: "Löst bei Attacken die mehrmals Treffen bei jedem Treffer aus.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    {
                        effect: "will o wisp triggert die Fähigkeit nicht bei Pokémon die immun gegen burn sind.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "will o wisp does not trigger this ability for Pokémon immune to burns.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
    ...
    "22": {
        ...
        effect_changes: [
            ...
            },
            {
                effect_entries: [
                    {
                        effect: "Hat keinen Effekt, wenn die Fähigkeit nach Kampfbeginn erlangt wurde.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    {
                        effect: "Verursacht nur 1/16 der maximalen hp des Angreifers Schaden.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Inflicts only 1/16 of the attacker's maximum HP in damage.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    {
                        effect: "fire fang und Attacken die typenlosen Schaden verursachen, ignorieren diese Fähigkeit unabhängig von ihrem Typ.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "fire fang and moves that inflict typeless damage ignore this ability regardless of type.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
    ...
    "28": {
        ...
        effect_changes: [
            ...
            },
            {
                effect_entries: [
                    {
                        effect: "Kann das Wesen von Pokémon mit denen in der Spielwelt interagiert wird nicht verändern.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Cannot influence the natures of Pokémon encountered by interacting with them on the overworld.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
    ...
    "31": {
        ...
        effect_changes: [
            ...
            },
            {
                effect_entries: [
                    {
                        effect: "Betrifft keine electric-Attacken die keinen Schaden anrichten, wie thunder wave. Erhöht die Anzahl an Trainer-Anrufen wenn irgendein Pokémon im Team diese Fähigkeit hat.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Does not affect non-damaging electric moves, i.e. thunder wave.  Increases the frequency of Match Call calls on the overworld if any party Pokémon has this ability.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
            ...
            },
            {
                effect_entries: [
                    {
                        effect: "Leitet electric-Attacken um, ohne ihre Effekte zu deaktivieren oder einen special attack Bonus zu gewähren. Leitet hidden power nicht um.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Redirects electric moves without negating them or granting any Special Attack boost.  Does not redirect hidden power.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    {
                        effect: "Hindert heal bell daran, das Pokémon zu heilen, auch außerhalb vom Kampf.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Prevents heal bell from curing the Pokémon, whether or not it is in battle.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
    ...
    "46": {
        ...
        effect_changes: [
            ...
            },
            {
                effect_entries: [
                    {
                        effect: "Betrifft keine Attacken von Teammitgliedern die alle anderen Pokémon als Ziel haben. Diese Fähigkeit wird im Kampf nicht angekündigt.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Does not affect friendly Pokémon's moves that target all other Pokémon.  This ability's presence is not announced upon entering battle.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
    ...
    "52": {
        ...
        effect_changes: [
            ...
            },
            {
                effect_entries: [
                    {
                        effect: "Verdoppelt den Radius in dem cut Gras entfernt, wenn irgendein Pokémon im Team diese Fähigkeit hat.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Doubles cut's grass-cutting radius on the overworld if any party Pokémon has this ability.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
    ...
    "68": {
        ...
        effect_changes: [
            ...
            },
            {
                effect_entries: [
                    {
                        effect: "Erhöht die Anzahl an Rufen die man außerhalb vom Kampf hört, wenn irgendein Pokémon im Team diese Fähigkeit hat.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Increases the frequency of cries heard on the overworld if any party Pokémon has this ability.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    {
                        effect: "paralysis hindert das Pokémon nicht daran sich zu bewegen, aber der speed Malus bleibt. poison schadet dem Pokémon außerhalb vom Kampf.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Paralysis cannot prevent the Pokémon from moving, though the Speed cut is unaffected.  Poison still damages the Pokémon outside of battle.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    {
                        effect: "Wegen eines Glitches haben Attacken die von dieser Fähigkeit beeinflusst sind eine (100 - Genauigkeit)% Chance durch den detect oder protect zu treffen.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Due to a glitch, moves affected by this ability have a (100 - accuracy)% chance to hit through detect or protect.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    ...
                    {
                        effect: "struggle is unaffected.  helping hand and defense curl are not taken into account.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
        ...
        effect_changes: [
            {
                effect_entries: [
                    {
                        effect: "Leitet water-Attacken um ohne den special attack Bonus zu gewähren. Leitet hidden power nicht um.",
                        language: {
                            name: "de",
                            url: "https://pokeapi.co/api/v2/language/6/",
                        },
                    ...
                    {
                        effect: "Redirects water moves without negating them or granting any Special Attack boost.  Does not redirect hidden power.",
                        language: {
                            name: "en",
                            url: "https://pokeapi.co/api/v2/language/9/",
                        },
